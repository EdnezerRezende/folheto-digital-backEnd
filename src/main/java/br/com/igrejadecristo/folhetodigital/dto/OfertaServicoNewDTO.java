...
public class OfertaServicoNewDTO implements Serializable {
	...
	public OfertaServicoNewDTO(Integer id, @NotEmpty(message = "Preenchimento obrigatório") String nome,
			...
			@NotEmpty(message = "Preenchimento obrigatório") Set<String> telefones,
			@NotEmpty(message = "Preenchimento obrigatório") String emailServico,
			@NotEmpty(message = "Preenchimento obrigatório") String instagram,
			@NotEmpty(message = "Preenchimento obrigatório") String facebook,
			@NotEmpty(message = "Preenchimento obrigatório") String endereco,
			@NotEmpty(message = "Preenchimento obrigatório") String dataCriacao
			) {
		super();
		this.id = id;
		this.nome = nome;
